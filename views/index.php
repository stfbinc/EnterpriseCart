				...
				<div class="main-menu">
					...
					<ul>
						...
						<div class="mega-menu">
							...
							<a href="shop.html"><img src="assets/img/5_hover_2.jpg" alt="" /></a>
						    </span>
						</div>										
					    </li>
	...
	<div class="slider-wrap">
		...
		<div class="fullwidthbanner">
			...
			<li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-saveperformance="on">
                            <!--MAIN IMAGE-->
                            <img src="assets/img/slider/slider1.jpg" alt="" data-bgposition="center top" data-duration=""
			...
			<li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-saveperformance="on">
                            <!--MAIN IMAGE-->
                            <img src="assets/img/slider/slider6_2.jpg" alt="" data-bgposition="center center" data-duration=""
				data-ease="Power0.easeInOut" data-bgfit="cover" data-bgrepeat="no-repeat" />
                            <!-- LAYER NR. -->
                            <div class="tp-caption skewfromrightshort skewtorightshort tp-resizeme" data-x="center"
				data-hoffset="0" data-y="center" data-voffset="-150" data-speed="500" data-start="500"
	...
	<div class="banner-area">
		...
		<div class="row">
			...
			<div class="single-banner">
                            <a href="#"><span>
				<img src="assets/img/banner/banner-14.jpg" alt=""></span></a>
			</div>
                    </div>
                    <!-- single-banner end -->
                    <!-- single-banner start -->
			...
			<div class="single-banner">
				...
				<img src="assets/img/banner/banner-15.jpg" alt=""></span></a>
			</div>
                    </div>
                    <!-- single-banner end -->
                    <!-- single-banner start -->
			...
			<div class="single-banner">
                            <a href="#"><span>
				<img src="assets/img/banner/banner-16.jpg" alt=""></span></a>
			</div>
                    </div>
                    <!-- single-banner end -->
                    <!-- single-banner start -->
			...
			<div class="single-banner">
                            <a class="last-banner" href="#"><span>
				<img src="assets/img/banner/banner-17.jpg" alt=""></span></a>
			</div>
                    </div>
                    <!-- single-banner end -->
		</div>
					...
					<div class="product-curosel">
						...
						<div class="single-product">
							...
							<a href="single-product.html">
                                                            <img class="primary-img" src="assets/img/product/1.jpg" alt="" />
                                                            <img class="secondary-img" src="assets/img/product/2.jpg" alt="" />
						...
						<div class="single-product">
                                                    <div class="product-img">
							<a href="single-product.html">
                                                            <img class="primary-img" src="assets/img/product/12.jpg" alt="" />
                                                            <img class="secondary-img" src="assets/img/product/13.jpg" alt="" />
							</a>
							<div class="product-action">
                                                            <div class="pro-button-top">
								<a href="#">add to cart</a>
						...
						<div class="single-product">
                                                    <div class="product-img">
							<a href="single-product.html">
                                                            <img class="primary-img" src="assets/img/product/5.jpg" alt="" />
                                                            <img class="secondary-img" src="assets/img/product/6.jpg" alt="" />
							</a><span class="sale">sale</span>
							<div class="product-action">
                                                            <div class="pro-button-top">
								<a href="#">add to cart</a>
						...
						<div class="single-product">
                                                    <div class="product-img">
							<a href="single-product.html">
                                                            <img class="primary-img" src="assets/img/product/14.jpg" alt="" />
                                                            <img class="secondary-img" src="assets/img/product/1.jpg" alt="" />
							</a>
							<div class="product-action">
                                                            <div class="pro-button-top">
								<a href="#">add to cart</a>
						...
						<div class="single-product">
                                                    <div class="product-img">
							<a href="single-product.html">
                                                            <img class="primary-img" src="assets/img/product/9.jpg" alt="" />
                                                            <img class="secondary-img" src="assets/img/product/10.jpg" alt="" />
							</a><span class="sale">sale</span>
							<div class="product-action">
                                                            <div class="pro-button-top">
								<a href="#">add to cart</a>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="product-img">
                                    <a href="single-product.html">
					<img class="primary-img" src="assets/img/product/1.jpg" alt="" />
					<img class="secondary-img" src="assets/img/product/4.jpg" alt="" />
                                    </a><span class="sale">sale</span>
                                    <div class="product-action">
					<div class="pro-button-top">
                                            <a href="#">add to cart</a>
			...
			<div class="col-lg-12">
				...
				<div class="product-img">
                                    <a href="single-product.html">
					<img class="primary-img" src="assets/img/product/2.jpg" alt="" />
					<img class="secondary-img" src="assets/img/product/14.jpg" alt="" />
                                    </a>
                                    <div class="product-action">
					<div class="pro-button-top">
                                            <a href="#">add to cart</a>
			...
			<div class="col-lg-12">
				...
				<div class="product-img">
                                    <a href="single-product.html">
					<img class="primary-img" src="assets/img/product/3.jpg" alt="" />
					<img class="secondary-img" src="assets/img/product/12.jpg" alt="" />
                                    </a><span class="sale">sale</span>
                                    <div class="product-action">
					<div class="pro-button-top">
                                            <a href="#">add to cart</a>
			...
			<div class="col-lg-12">
				...
				<div class="product-img">
                                    <a href="single-product.html">
					<img class="primary-img" src="assets/img/product/7.jpg" alt="" />
					<img class="secondary-img" src="assets/img/product/8.jpg" alt="" />
                                    </a>
                                    <div class="product-action">
					<div class="pro-button-top">
                                            <a href="#">add to cart</a>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="latest-blog-img">
                                    <a href="#">
					<img src="assets/img/blog/blog1.jpg" alt="" /></a>
				</div>
			...
			<div class="col-lg-12">
				...
				<div class="latest-blog-img">
                                    <a href="#">
					<img src="assets/img/blog/blog2.jpg" alt="" /></a>
				</div>
				<div class="latest-blog-content">
                                    <h3>
					<a href="#">Nam liber tempor cum soluta</a></h3>
			...
			<div class="col-lg-12">
				...
				<div class="latest-blog-img">
                                    <a href="#">
					<img src="assets/img/blog/blog3.jpg" alt="" /></a>
				</div>
				<div class="latest-blog-content">
                                    <h3>
					<a href="#">Nam liber tempor cum soluta</a></h3>
	...
	<div class="brand-area pad-bottom pad-top-60">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<a href="#">
                                    <img src="assets/img/brand/1.png" alt="" /></a>
                            </div>
			</div>
			<div class="col-lg-12">
                            <div class="single-brand">
