            ...
            <td>
                <div class="boxspacer">
                    <p>
                        <strong>
                            <br />
                            <em><a href="default.php">Store</a> &gt;Product Category</em></strong></p>';
...
if(isset($_GET["category"])){
	$_SESSION["familyID"]=$_GET["category"];
}
$familyID=$_SESSION["familyID"];
$sql="select * from $table_family where CompanyID='DINOS' and DepartmentID='DEFAULT' and ItemFamilyID='".$familyID."'";
...
if($_SESSION["az"]=="Z-A Name"){
	$sql="select * from $table_family where CompanyID='DINOS' and DepartmentID='DEFAULT' and ItemFamilyID='".$familyID."' order by CategoryName desc";                        
}else{
	$sql="select * from $table_family where CompanyID='DINOS' and DepartmentID='DEFAULT' and ItemFamilyID='".$familyID."' order by CategoryName";       
} 
                            ...
                            <table border="0" width="100%" bgcolor="#ffffff" cellpadding="3" cellspacing="3">
                                <tr>
                                    <td width="10%" rowspan="4" align="left" valign="bottom">
                                        <a href="productList.php?CategoryID='.$row["ItemCategoryID"].'" border=0><img src="'.$row["CategoryPictureURL"].'" width=120 height=80 border=0></a>
                                    </td>
