...
$sql="select * from $table_category where CompanyID='DINOS' and DepartmentID='DEFAULT'";
...
if($_SESSION["az"]=="Z-A Name"){
	$sql="select * from $table_category where CompanyID='DINOS' and DepartmentID='DEFAULT' order by FamilyName desc";                        
}else{
	$sql="select * from $table_category where CompanyID='DINOS' and DepartmentID='DEFAULT' ";       
} 
                            ...
                            <table border="0" width="100%" bgcolor="#ffffff" cellpadding="3" cellspacing="3">
                                <tr>
                                    <td width="10%" rowspan="4" align="left" valign="bottom">
                                        <a href="productcategories.php?category='.$row["ItemFamilyID"].'" border=0><img src="'.$row["FamilyPictureURL"].'" width=120 height=80 border=0></a>
                                    </td>
