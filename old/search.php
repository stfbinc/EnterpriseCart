...
$sql="select id from $table_product where product like '%".$keyword."%' or intro like '%".$keyword."%'";
...
if($_SESSION["az"]=="Z-A Name"){
	$sql="select * from $table_product where product like '%".$keyword."%' or intro like '%".$keyword."%' order by category desc";                        
}else{
	$sql="select * from $table_product where product like '%".$keyword."%' or intro like '%".$keyword."%'";       
} 
                            ...
                            <table border="0" width="100%" bgcolor="#ffffff" cellpadding="3" cellspacing="3">
                                <tr>
                                    <td width="10%" rowspan="4" align="left" valign="bottom">
                                        <a href="cartitem.php?id='.$row["id"].'"><img src="'.$row["image"].'" width=120 height=80 border=0></a>
                                    </td>
